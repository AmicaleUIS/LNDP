-- ============================================================
-- LE NID DES PRONOS — OUTIL DEMO PDF FINAL — VERSION SQL EDITOR V4 — SANS PGCRYPTO
-- Crée un joueur fictif qui a pronostiqué toute la compétition.
-- V4 : ne dépend plus de crypt()/gen_salt(), donc compatible Supabase sans pgcrypto exposé.
