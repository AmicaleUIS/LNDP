-- ============================================================
-- LE NID DES PRONOS — PATCH V1.8.8b
-- Recalcul super admin + DROP/CREATE v_visible_predictions
-- ============================================================
...
-- PostgreSQL n'autorise pas CREATE OR REPLACE VIEW si l'ordre ou le nom
-- des colonnes change. On supprime donc la vue avant de la recréer.
drop view if exists public.v_visible_predictions;
