// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.18
// Cache public V1.8.18 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.18",
  "./css/bilan.css?v=1.8.18",
  "./js/supabaseClient.js?v=1.8.18",
  "./js/auth.js?v=1.8.18",
  "./js/common.js?v=1.8.18",
  "./js/app.js?v=1.8.18",
  "./js/admin.js?v=1.8.18",
  "./js/bilan.js?v=1.8.18",
  "./manifest.json?v=1.8.18",
