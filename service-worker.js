// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.3.12
// Cache public V1.3.12 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-3-12";
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.3.12",
  "./css/bilan.css?v=1.3.12",
  "./js/supabaseClient.js?v=1.3.12",
  "./js/auth.js?v=1.3.12",
  "./js/common.js?v=1.3.12",
  "./js/app.js?v=1.3.12",
  "./js/admin.js?v=1.3.12",
  "./js/bilan.js?v=1.3.12",
