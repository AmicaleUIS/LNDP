// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.18
// Cache public V1.0.18 : identifiant UIS + mini-records dynamiques.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-18";
...
const ASSETS = [
  ...
  "./app.html",
  "./admin.html",
  "./css/style.css?v=1.0.18",
  "./js/supabaseClient.js?v=1.0.18",
  "./js/auth.js?v=1.0.18",
  "./js/common.js?v=1.0.18",
  "./js/app.js?v=1.0.18",
  "./js/admin.js?v=1.0.18",
