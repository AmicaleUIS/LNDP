// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.23
// Cache public V1.8.23 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.23",
  "./css/bilan.css?v=1.8.23",
  "./js/supabaseClient.js?v=1.8.23",
  "./js/auth.js?v=1.8.23",
  "./js/common.js?v=1.8.23",
  "./js/app.js?v=1.8.23",
  "./js/admin.js?v=1.8.23",
  "./js/bilan.js?v=1.8.23",
  "./manifest.json?v=1.8.23",
