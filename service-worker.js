// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.4
// Cache public V1.0.4 : assets statiques + correctifs mobile.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-4";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.0.4",
  "./js/auth.js?v=1.0.4",
  "./js/common.js?v=1.0.4",
  "./js/app.js?v=1.0.4",
  "./js/admin.js?v=1.0.4",
