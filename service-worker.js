// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.3.46
// Cache public V1.3.46 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-3-46";
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.3.46",
  "./css/bilan.css?v=1.3.46",
  "./js/supabaseClient.js?v=1.3.46",
  "./js/auth.js?v=1.3.46",
  "./js/common.js?v=1.3.46",
  "./js/app.js?v=1.3.46",
  "./js/admin.js?v=1.3.46",
  "./js/bilan.js?v=1.3.46",
  "./manifest.json?v=1.3.46",
