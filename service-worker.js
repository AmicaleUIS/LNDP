// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.25
// Cache public V1.8.25 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.25",
  "./css/bilan.css?v=1.8.25",
  "./js/supabaseClient.js?v=1.8.25",
  "./js/auth.js?v=1.8.25",
  "./js/common.js?v=1.8.25",
  "./js/app.js?v=1.8.25",
  "./js/admin.js?v=1.8.25",
  "./js/bilan.js?v=1.8.25",
  "./manifest.json?v=1.8.25",
