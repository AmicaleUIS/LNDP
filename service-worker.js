// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.34
// Cache public V1.8.34 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.34",
  "./css/bilan.css?v=1.8.34",
  "./js/supabaseClient.js?v=1.8.34",
  "./js/auth.js?v=1.8.34",
  "./js/common.js?v=1.8.34",
  "./js/app.js?v=1.8.34",
  "./js/admin.js?v=1.8.34",
  "./js/bilan.js?v=1.8.34",
  "./manifest.json?v=1.8.34",
