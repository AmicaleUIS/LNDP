// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.33
// Cache public V1.8.33 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.33",
  "./css/bilan.css?v=1.8.33",
  "./js/supabaseClient.js?v=1.8.33",
  "./js/auth.js?v=1.8.33",
  "./js/common.js?v=1.8.33",
  "./js/app.js?v=1.8.33",
  "./js/admin.js?v=1.8.33",
  "./js/bilan.js?v=1.8.33",
  "./manifest.json?v=1.8.33",
