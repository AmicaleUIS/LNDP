// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.6.0
// Cache public V1.6.0 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-6-0";
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.6.0",
  "./js/supabaseClient.js?v=1.6.0",
  "./js/auth.js?v=1.6.0",
