// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.11
// Cache public V1.8.11 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-8-11";
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.11",
  "./css/bilan.css?v=1.8.11",
  "./js/supabaseClient.js?v=1.8.11",
  "./js/auth.js?v=1.8.11",
  "./js/common.js?v=1.8.11",
  "./js/app.js?v=1.8.11",
  "./js/admin.js?v=1.8.11",
  "./js/bilan.js?v=1.8.11",
