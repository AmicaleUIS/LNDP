// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.39
// Cache public V1.8.39 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.39",
  "./css/bilan.css?v=1.8.39",
  "./js/supabaseClient.js?v=1.8.39",
  "./js/auth.js?v=1.8.39",
  "./js/common.js?v=1.8.39",
  "./js/app.js?v=1.8.39",
  "./js/admin.js?v=1.8.39",
  "./js/bilan.js?v=1.8.39",
  "./manifest.json?v=1.8.39",
