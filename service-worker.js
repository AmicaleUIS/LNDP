// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.9
// Cache public V1.0.9 : assets statiques + dashboard mobile/desktop corrigé.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-9";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.0.9",
  "./js/auth.js?v=1.0.9",
  "./js/common.js?v=1.0.9",
  "./js/app.js?v=1.0.9",
  "./js/admin.js?v=1.0.9",
