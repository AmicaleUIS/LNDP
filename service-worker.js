// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.9.3
// Cache public V1.9.3 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.9.3",
  "./js/supabaseClient.js?v=1.9.3",
  "./js/auth.js?v=1.9.3",
  "./js/common.js?v=1.9.3",
  "./js/app.js?v=1.9.3",
  "./js/admin.js?v=1.9.3",
  "./js/bilan.js?v=1.9.3",
