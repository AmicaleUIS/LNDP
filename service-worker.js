// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.11
// Cache public V1.0.11 : assets statiques + dashboard mobile/desktop corrigé.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-11";
...
const ASSETS = [
  ...
  "./app.html",
  "./admin.html",
  "./css/style.css?v=1.0.11",
  "./js/supabaseClient.js?v=1.0.11",
  "./js/auth.js?v=1.0.11",
  "./js/common.js?v=1.0.11",
  "./js/app.js?v=1.0.11",
  "./js/admin.js?v=1.0.11",
