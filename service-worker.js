// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.2.5
// Cache public V1.2.5 : santé du Nid + journal admin.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-2-5";
...
const ASSETS = [
  ...
  "./app.html",
  "./admin.html",
  "./css/style.css?v=1.2.5",
  "./js/supabaseClient.js?v=1.2.5",
  "./js/auth.js?v=1.2.5",
  "./js/common.js?v=1.2.5",
  "./js/app.js?v=1.2.5",
  "./js/admin.js?v=1.2.5",
