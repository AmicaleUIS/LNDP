// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.3.34
// Cache public V1.3.34 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-3-34";
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.3.34",
  "./css/bilan.css?v=1.3.34",
  "./js/supabaseClient.js?v=1.3.34",
  "./js/auth.js?v=1.3.34",
  "./js/common.js?v=1.3.34",
  "./js/app.js?v=1.3.34",
  "./js/admin.js?v=1.3.34",
  "./js/bilan.js?v=1.3.34",
  "./manifest.json?v=1.3.34",
