// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.9.13
// Cache public V1.9.13 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.9.13",
  "./css/bilan.css?v=1.9.13",
  "./js/supabaseClient.js?v=1.9.13",
  "./js/auth.js?v=1.9.13",
  "./js/common.js?v=1.9.13",
  "./js/app.js?v=1.9.13",
  "./js/admin.js?v=1.9.13",
  "./js/bilan.js?v=1.9.13",
