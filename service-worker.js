// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.1.2
// Cache public V1.1.2 : identifiant UIS + mini-records dynamiques.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-1-2";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.1.2",
  "./js/auth.js?v=1.1.2",
  "./js/common.js?v=1.1.2",
  "./js/app.js?v=1.1.2",
  "./js/admin.js?v=1.1.2",
