// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.6.2
// Cache public V1.6.2 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-6-2";
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.6.2",
  "./js/supabaseClient.js?v=1.6.2",
  "./js/auth.js?v=1.6.2",
  "./js/common.js?v=1.6.2",
  "./js/app.js?v=1.6.2",
  "./js/admin.js?v=1.6.2",
  "./js/bilan.js?v=1.6.2",
