// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.2.6
// Cache public V1.2.6 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-2-6";
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.2.6",
  "./js/supabaseClient.js?v=1.2.6",
  "./js/auth.js?v=1.2.6",
  "./js/common.js?v=1.2.6",
  "./js/app.js?v=1.2.6",
  "./js/admin.js?v=1.2.6",
  "./js/bilan.js?v=1.2.6",
