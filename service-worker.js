// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.38
// Cache public V1.8.38 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.38",
  "./css/bilan.css?v=1.8.38",
  "./js/supabaseClient.js?v=1.8.38",
  "./js/auth.js?v=1.8.38",
  "./js/common.js?v=1.8.38",
  "./js/app.js?v=1.8.38",
  "./js/admin.js?v=1.8.38",
  "./js/bilan.js?v=1.8.38",
  "./manifest.json?v=1.8.38",
