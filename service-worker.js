// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.35
// Cache public V1.8.35 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.35",
  "./css/bilan.css?v=1.8.35",
  "./js/supabaseClient.js?v=1.8.35",
  "./js/auth.js?v=1.8.35",
  "./js/common.js?v=1.8.35",
  "./js/app.js?v=1.8.35",
  "./js/admin.js?v=1.8.35",
  "./js/bilan.js?v=1.8.35",
  "./manifest.json?v=1.8.35",
