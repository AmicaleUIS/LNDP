// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.1.1
// Cache public V1.1.1 : identifiant UIS + mini-records dynamiques.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-1-1";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.1.1",
  "./js/auth.js?v=1.1.1",
  "./js/common.js?v=1.1.1",
  "./js/app.js?v=1.1.1",
  "./js/admin.js?v=1.1.1",
