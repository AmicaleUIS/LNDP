// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.24
// Cache public V1.8.24 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.24",
  "./css/bilan.css?v=1.8.24",
  "./js/supabaseClient.js?v=1.8.24",
  "./js/auth.js?v=1.8.24",
  "./js/common.js?v=1.8.24",
  "./js/app.js?v=1.8.24",
  "./js/admin.js?v=1.8.24",
  "./js/bilan.js?v=1.8.24",
  "./manifest.json?v=1.8.24",
