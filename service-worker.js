// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.3.1
// Cache public V1.3.1 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-3-1";
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.3.1",
  "./js/supabaseClient.js?v=1.3.1",
  "./js/auth.js?v=1.3.1",
  "./js/common.js?v=1.3.1",
  "./js/app.js?v=1.3.1",
  "./js/admin.js?v=1.3.1",
  "./js/bilan.js?v=1.3.1",
