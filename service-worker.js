// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.5
// Cache public V1.0.5 : assets statiques + dashboard mobile/desktop corrigé.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-5";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.0.5",
  "./js/auth.js?v=1.0.5",
  "./js/common.js?v=1.0.5",
  "./js/app.js?v=1.0.5",
  "./js/admin.js?v=1.0.5",
