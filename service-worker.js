// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.9.1
// Cache public V1.9.1 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.9.1",
  "./js/supabaseClient.js?v=1.9.1",
  "./js/auth.js?v=1.9.1",
  "./js/common.js?v=1.9.1",
  "./js/app.js?v=1.9.1",
  "./js/admin.js?v=1.9.1",
  "./js/bilan.js?v=1.9.1",
