// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.0.10
// Cache public V1.0.10 : assets statiques + dashboard mobile/desktop corrigé.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-0-10";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.0.10",
  "./js/auth.js?v=1.0.10",
  "./js/common.js?v=1.0.10",
  "./js/app.js?v=1.0.10",
  "./js/admin.js?v=1.0.10",
