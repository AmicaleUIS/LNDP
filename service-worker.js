// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.3.40
// Cache public V1.3.40 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-3-40";
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.3.40",
  "./css/bilan.css?v=1.3.40",
  "./js/supabaseClient.js?v=1.3.40",
  "./js/auth.js?v=1.3.40",
  "./js/common.js?v=1.3.40",
  "./js/app.js?v=1.3.40",
  "./js/admin.js?v=1.3.40",
  "./js/bilan.js?v=1.3.40",
  "./manifest.json?v=1.3.40",
