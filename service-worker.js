// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.3
// Cache public V1.8.3 : bilan PDF final temps réel.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-8-3";
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.8.3",
  "./js/supabaseClient.js?v=1.8.3",
  "./js/auth.js?v=1.8.3",
  "./js/common.js?v=1.8.3",
  "./js/app.js?v=1.8.3",
  "./js/admin.js?v=1.8.3",
  "./js/bilan.js?v=1.8.3",
