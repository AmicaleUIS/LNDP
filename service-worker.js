// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.8.36
// Cache public V1.8.36 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./admin.html",
  "./bilan.html",
  "./css/style.css?v=1.8.36",
  "./css/bilan.css?v=1.8.36",
  "./js/supabaseClient.js?v=1.8.36",
  "./js/auth.js?v=1.8.36",
  "./js/common.js?v=1.8.36",
  "./js/app.js?v=1.8.36",
  "./js/admin.js?v=1.8.36",
  "./js/bilan.js?v=1.8.36",
  "./manifest.json?v=1.8.36",
