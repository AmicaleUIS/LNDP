// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.1.3
// Cache public V1.1.3 : identifiant UIS + mini-records dynamiques.
// ============================================================

const CACHE_NAME = "le-nid-des-pronos-v1-1-3";
...
const ASSETS = [
  ...
  "./js/supabaseClient.js?v=1.1.3",
  "./js/auth.js?v=1.1.3",
  "./js/common.js?v=1.1.3",
  "./js/app.js?v=1.1.3",
  "./js/admin.js?v=1.1.3",
