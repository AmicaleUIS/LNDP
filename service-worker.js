// ============================================================
// LE NID DES PRONOS — SERVICE WORKER V1.9.10
// Cache public V1.9.10 : bilan PDF final temps réel.
// ============================================================
...
const ASSETS = [
  ...
  "./css/bilan.css?v=1.9.10",
  "./js/supabaseClient.js?v=1.9.10",
  "./js/auth.js?v=1.9.10",
  "./js/common.js?v=1.9.10",
  "./js/app.js?v=1.9.10",
  "./js/admin.js?v=1.9.10",
  "./js/bilan.js?v=1.9.10",
